 ...
 */ export const messagesES = {
    ...
    // Field
    fdFsImbalance: (fd, fs)=>`Desequilibrio de campos: ${fd} ^FD encontrados pero ${fs} ^FS`,
    ...
    suggestCheckLabelSize: 'Verifique que las coordenadas esten dentro del tamano de etiqueta',
    // Barcode
    ...
    suggestAddBarcodeData: 'Agregue datos en ^FD despues del comando de codigo de barras',
    // Command
