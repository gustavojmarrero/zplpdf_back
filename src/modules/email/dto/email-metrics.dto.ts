...
export class EmailMetricsDto {
  ...
  @ApiProperty({
    example: 40.32,
    description: 'Click rate percentage (clicks/opens)',
  })
  clickRate: number;
}
...
export class AbVariantMetricsDto {
  ...
  @ApiProperty({
    example: 50,
    description: 'Total emails sent for this variant',
  })
  sent: number;

  @ApiProperty({
    example: 48,
    description: 'Total emails delivered for this variant',
  })
  delivered: number;

  @ApiProperty({
    example: 22,
    description: 'Total emails opened for this variant',
  })
  opened: number;

  @ApiProperty({
    example: 10,
    description: 'Total emails clicked for this variant',
  })
  clicked: number;

  @ApiProperty({
    example: 44,
    description: 'Open rate percentage for this variant',
  })
  openRate: number;

  @ApiProperty({
    example: 45.45,
    description: 'Click rate percentage for this variant',
  })
  clickRate: number;
}
...
export class EmailMetricsByTypeDto {
  ...
  @ApiProperty({
    ...
    description: 'Metrics for this email type',
  })
...
export class OnboardingFunnelDto {
  @ApiProperty({
    example: 1000,
    description: 'Total registered users in period',
  })
  registeredUsers: number;

  @ApiProperty({
    example: 950,
    description: 'Users who received welcome email',
  })
  ...
  @ApiProperty({
    example: 142,
    description: 'Users who clicked in welcome email',
  })
  clickedWelcome: number;

  @ApiProperty({
    example: 300,
    description: 'Users who generated at least 1 PDF',
  })
  firstPdfGenerated: number;

  @ApiProperty({
    example: 280,
    description: 'Users activated (≥1 PDF) within 7 days',
  })
